...
export const partnerPacks: PartnerPack[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "4 abonnements match à domicile",
  ...
  },
  {
    ...
    price: "6 000 €",
    benefits: [
      "Panneau affichage stade : 4x1 ou à la demande",
      "Panneau partenaires entrée stade",
      "6 abonnements match à domicile",
      "Membre club 1905 – réseau SMRC business",
      "Parution à la mi-temps & dans la Gazette",
      "Invitation soirée Partenaires",
      "Annonce du partenariat",
      "4 bracelets noirs & accès terrasse",
      "2 accès salon l'Argilus du Roi (+ 1 000 €)",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Panneau partenaires entrée stade",
      "Membre club 1905 – SMRC business",
      "10 abonnements match à domicile",
      ...
      "Accès terrasse partenaires",
      "All Digital – vidéo promotionnelle",
    ],
    featured: true,
  },
];
